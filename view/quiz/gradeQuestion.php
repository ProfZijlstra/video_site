...
<head>
    ...
    <script src="<?= $MY_BASE ?>/res/js/quiz/gradeQuestion-1.0.js"></script>
        ...
        <div id="content">
            ...
            <div class="gradeContainer">
                ...
                <?php for ($i = 0; $i < count($answers); $i++) { ?>
                    ...
                    <div class="points">
                        <input type="number" autofocus value="<?= $answer['points'] ?? '' ?>" step="0.01" max="<?= $question['points'] ?>" min="0" name="points" class="points" />
                    </div>
                <?php } ?>
            </div>
